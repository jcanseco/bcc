...
lib.bpf_module_create_c.argtypes = [ct.c_char_p, ct.c_uint,
        ct.POINTER(ct.c_char_p), ct.c_int, _MAP_CB_TYPE, ct.py_object]
...
lib.bcc_remote_ksymcache_new.restype = ct.c_void_p
lib.bcc_remote_ksymcache_new.argtypes = [ct.POINTER(ct.c_char_p), ct.c_int]
